...
extern "C" {
    pub fn gbm_device_is_format_supported(gbm: *mut gbm_device, format: u32, flags: u32) -> libc::c_int;
}
extern "C" {
    pub fn gbm_device_get_format_modifier_plane_count(gbm: *mut gbm_device, format: u32, modifier: u64) -> libc::c_int;
}
extern "C" {
...
extern "C" {
    pub fn gbm_bo_import(gbm: *mut gbm_device, type_: u32, buffer: *mut libc::c_void, flags: u32) -> *mut gbm_bo;
}
...
extern "C" {
    pub fn gbm_bo_set_user_data(
        ...
        destroy_user_data: ::std::option::Option<unsafe extern "C" fn(arg1: *mut gbm_bo, arg2: *mut libc::c_void)>,
    );
}
extern "C" {
